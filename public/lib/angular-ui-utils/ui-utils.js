...
// modeled after: angular-1.0.7/src/ng/directives/ngInclude.js
				...
				compile: function(element, attr, linker) {
					return function($scope, $element, $attr, controllers) {
						...
						linker(tempScope = $scope.$new(), function(template) {
							...
							if (repeaterType === 'dl') {
								throw new Error('ng-scroll directives does not support <' + template[0].localName + '> as a repeating tag: ' + template[0].outerHTML);
							}
...
angular.module('ui.scrollfix',[]).directive('uiScrollfix', ['$window', function ($window) {
  return {
    ...
    link: function (scope, elm, attrs, uiScrollfixTarget) {
      ...
      // Unbind scroll event handler when directives is removed
      scope.$on('$destroy', function() {
 ...
 * The ui-validate directives makes it easy to use any function(s) defined in scope as a validator function(s).
